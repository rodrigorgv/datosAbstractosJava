...
<html lang="en">
    ...
    <body>
        ...
        <main class="main">
            <form action="srvPila" class="menuContainer" method="get">
                <h2>Menu</h2>
                <div class="menu">
                    <button class="btn" type="button" onclick="mostrar()">apilar</button>
                    <div id="datos" class="datosNuevo">
                        <div class="tittle">
                            ...
                            <h3>Ingrese el dato que desea Apilar</h3>

                        </div>
                        <input type="text" name="txtDato" class="txtdato" placeholder="ingrese el dato aqui" required>
                        <button type="submit" value="add" name="btn" class="btn">APILAR</button>
                    </div>
                    <button  class="btn" type="button" onclick="mostrar2()">desapilar</button>
            </form>
            ...
            <div id="datos2" class="datosNuevo">
                ...
                <div class="tittle">
                    ...
                    <form action="srvPila" method="get">
                </div>
    ...
    <div class="datos">
        ...
        <table class="table" border="2">
            ...
            <%
                ...
                if (request.getAttribute("datos") != null) {
                    ...
                    if (valor == 0) {
                        ...
                        String[] pilaOrdenada = new String[10];
                        int a = 0;
                        for (int j = 9; j >= 0; j--) {
                            if (datos[j] != null) {
                                pilaOrdenada[a] = datos[j];
                                a++;
                            }
                        }
            %>
            <script>
                <%for (int i = 0; i < 10; i++) {%>
                document.getElementById("position" + <%=i%>).innerText = `<%= pilaOrdenada[i]%>`;
                <%
                            }%>
            </script>
            <%
            ...
            %>
            <script>alert("ALERTA, la pila se encuentra llena, para continuar debe desapilar un dato")</script>
            <%
                    }
                }
            %>
